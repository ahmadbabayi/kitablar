<div class="memberbookadd">
    <ul>
        <li><?php echo anchor('member/booklist/', 'back'); ?></li>
        <li><?php echo anchor('member/addbook', 'Add new E-book') ?></li>
        <li><?php echo anchor('member/editbook/' . $row['id'], 'edit E-book details'); ?></li>
        <li><a href="<?php echo site_url() . '/member/removebook/' . $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');">remove E-book</a></li>
    </ul>
</div>
...
<?php endforeach; ?>
    ...
    <div id="loadergif"><img alt="rss" src="<?php echo base_url('images/upload.gif'); ?>"></div>
    <div class="memberfileupload">
...
<?php foreach ($filerow as $item): ?>
            ...
            <tr>
                ...
                <td><a href="<?php echo site_url() . '/member/removefile/' . $row['id'] . '/' . $item['id']; ?>" class="downloadbutton" onclick="return confirm('Are you sure you want to delete this item?');">remove</a></td>
            </tr>
<?php endforeach; ?>
