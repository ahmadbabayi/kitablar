...
class Admin extends CI_Controller {
    ...
    public function epubcreat() {
        ...
        $book->setPublisher("kitablar E-book management system", "http://kitablar.com/"); // I hope this is a non existant address :)
...
//    function buildTOC($cssFileName = NULL, $tocCSSClass = "toc", $title = "Table of Contents", $addReferences = TRUE, $addToIndex = FALSE, $tocFileName = "TOC.xhtml") {
        ...
        $chapter2 = "<h2>Vivamus bibendum massa</h2>\n"
...
// $book->buildTOC();
        ...
        $book->finalize();
        $bookepubfile = './data/epub/';
        $zipData = $book->saveBook('f1.epub', $bookepubfile);
    }
